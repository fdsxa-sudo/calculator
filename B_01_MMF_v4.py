...
def make_statement(statement, decoration):
    """Emphasises headings by adding decoration at the start
    and end"""
...
# lists to hold all ticket details
all_names = []
all_ticket_costs = []
all_surcharges = []
...
while tickets_sold < MAX_TICKETS:
    # ask user for their name (and check if exit code)
    print()
    name = not_blank("Name: ")
    ...
    # if by paying by credit, calculate surcharge
    else:
...
total_paid_string = "Total Paid: ${total_paid:.2f}"
total_profit_string = "Total profit: ${total_profit:.2f}"
...
final_total_paid_string = f"Total Paid: ${total_paid - ticket_won:.2f}"
...
tickets_details_heading = make_statement("Ticket Details", "-")
